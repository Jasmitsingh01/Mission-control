    ...
    <div className="overflow-hidden">
      ...
      <section className="relative pt-24 px-8">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-primary-container/10 rounded-full blur-[120px]" />
        ...
        <div className="relative max-w-7xl mx-auto py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <motion.h1
              className="text-5xl md:text-7xl font-black tracking-tight text-on-surface leading-[1.05]"
              initial="hidden" animate="visible" variants={fadeUp} custom={0}
            >
              Build AI Agent Teams.
              <br />
              <span className="text-secondary">Describe Your Goal.</span>
              <br />
              Watch It Execute.
            </motion.h1>

            <motion.p
              className="mt-6 text-lg text-on-surface-variant max-w-xl leading-relaxed"
            ...
            >
              <Link to="/signup">
                <button className="synthetic-gradient text-white px-8 py-3.5 rounded-xl text-base font-semibold flex items-center gap-2 hover:opacity-90 transition-opacity shadow-lg shadow-primary-container/30">
                  <Rocket className="h-5 w-5" />
                  Start for Free
                  <ArrowRight className="h-4 w-4" />
                </button>
              </Link>
              <button className="border border-outline-variant text-on-surface-variant px-8 py-3.5 rounded-xl text-base font-medium flex items-center gap-2 hover:bg-surface-container transition-colors">
            ...
            >
              ...
              <div className="flex items-center gap-5">
                {['OpenClaw', 'GPT-4o', 'Claude Sonnet'].map((name) => (
                  <span key={name} className="text-sm text-on-surface-variant font-medium font-mono opacity-60 hover:opacity-100 transition-opacity">
                    {name}
                  </span>
                ))}
              </div>
          ...
          >
            <div className="glass-panel rounded-2xl border border-outline-variant/30 p-4 shadow-2xl shadow-primary-container/10">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, i) => (
              ...
              >
                <p className="text-4xl lg:text-5xl font-extrabold text-primary font-mono">{stat.value}</p>
                <p className="mt-2 text-sm text-on-surface-variant font-mono">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-surface-dim">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div className="text-center mb-16" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-on-surface">From idea to execution in 3 steps</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                variants={fadeUp} custom={i}
              >
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-primary-container/20 border border-primary-container/30 mb-6">
                  <item.icon className="h-8 w-8 text-primary" />
                </div>
                <p className="text-xs font-bold text-secondary mb-2 font-mono tracking-wider">STEP {item.step}</p>
                <h3 className="text-xl font-bold mb-3 text-on-surface">{item.title}</h3>
      ...
      <section className="py-24 bg-surface-container-lowest">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div className="text-center mb-16" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-on-surface">Everything you need to orchestrate AI</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {features.map((feature, i) => (
              <motion.div
                ...
                variants={fadeUp} custom={i}
              >
                <div className="h-full glass-panel rounded-2xl border border-outline-variant/30 p-6 hover:border-primary/30 transition-all duration-300 group">
                  <div className="inline-flex rounded-xl bg-primary-container/20 p-3 mb-4 group-hover:scale-110 transition-transform duration-300">
                    <feature.icon className="h-6 w-6 text-primary" />
                  </div>
                  <h3 className="font-semibold text-lg mb-2 text-on-surface">{feature.title}</h3>
      ...
      <section className="py-24 bg-surface-dim">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-on-surface">Built for every workflow</h2>
          </motion.div>
            ...
            {useCaseTabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all ${
                  activeTab === tab
                    ? 'synthetic-gradient text-white shadow-lg shadow-primary-container/20'
          ...
          <motion.div
            key={activeTab}
            className="glass-panel rounded-2xl border border-outline-variant/30 p-8 md:p-12 max-w-4xl mx-auto"
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-on-surface mb-3">{currentUseCase.title}</h3>
              ...
              <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/20 p-6 h-64 flex items-center justify-center">
      ...
      <section className="py-24 bg-surface-container-lowest">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
            <div className="rounded-2xl p-px bg-gradient-to-r from-primary-container to-secondary">
              <div className="bg-surface-container-lowest rounded-2xl p-12">
                <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-on-surface">
                  Ready to <span className="text-primary">Command?</span>
                </h2>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link to="/signup">
                    <button className="synthetic-gradient text-white px-10 py-3.5 rounded-xl text-base font-semibold flex items-center gap-2 hover:opacity-90 transition-opacity shadow-lg shadow-primary-container/30">
                      <Rocket className="h-5 w-5" />
                      Get Started Free
                    </button>
                  </Link>
                  <Link to="/contact">
                    <button className="border border-outline-variant text-on-surface-variant px-10 py-3.5 rounded-xl text-base font-medium hover:bg-surface-container transition-colors">
                      Talk to Sales
                    </button>
                  </Link>
                </div>
